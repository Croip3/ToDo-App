...
export class TodoListService {
  ...
  private todosInternal$ = new ReplaySubject<Todo[]>();
  ...
  public observeTodoLists(): Observable<TodoList[]> {
    return this.todoListsInternal$.asObservable();
  }

  public observeTodos(): Observable<Todo[]> {
    return this.todosInternal$.asObservable();
  }
